...
export default function CaseStudyPage() {
  ...
  return (
    <div className="w-full bg-white relative pb-0 pt-[90px] xl:pt-[110px]">
      ...
      <section className="w-full max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-12 mb-8 sm:mb-20 lg:mb-24">
        <div className="w-full relative h-[340px] sm:h-[400px] lg:h-[500px] rounded-[32px] overflow-hidden flex justify-end bg-[#0a0a0a]">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 left-0 w-[92%] sm:w-[65%] lg:w-[52%] xl:w-[50%] bg-white h-auto py-10 sm:py-12 lg:py-18 xl:py-24 rounded-r-[40px] lg:rounded-r-[48px] z-10 flex flex-col justify-center px-8 sm:px-16 lg:px-24">
