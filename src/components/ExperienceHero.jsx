...
export default function ExperienceHero() {
  return (
    <section className="w-full bg-white relative overflow-hidden mt-0 pt-4 pb-8 lg:pb-16">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 relative">
        <div className="relative w-full rounded-[40px]">
          ...
          <div className="absolute top-[1%] sm:top-[8%] lg:top-[5%] left-[12%] sm:left-[8%] lg:left-[10%] z-10 flex flex-col items-start w-full sm:max-w-[75%] lg:max-w-[55%] text-left">

            {/* Project Experience Tag */}
            <div className="inline-flex items-center gap-1 sm:gap-2.5 bg-[#f0f7f4] text-[#0a0a0a] px-1.5 sm:px-6 py-0 sm:py-1.5 rounded-full text-[7.5px] sm:text-[15px] lg:text-[16px] font-[700] tracking-tight border border-[#cfe2d9] mb-1 sm:mb-5 lg:mb-6 sm:ml-4 lg:ml-6 ml-0">
              <div className="w-0.5 sm:w-2.5 h-0.5 sm:h-2.5 rounded-full bg-[#3e976c]"></div>
              Project Experience
            </div>
          ...
          {/* Mobile Green Button */}
          <div className="absolute bottom-[-4px] right-[-4px] z-30 lg:hidden">
            <button
              onClick={() => document.getElementById('next-section')?.scrollIntoView({ behavior: 'smooth' })}
