...
export default function SectionPill({ children, className = '' }) {
  return (
    <div
      className={`inline-flex items-center gap-2 bg-[#e8f2ee] text-[#0a0a0a] px-4 py-2 rounded-lg text-[12.5px] font-[600] tracking-tight border border-[#cfe2d9] ${className}`}
    >
