        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 pt-4 relative isolate">
          <div className="relative w-full h-[500px] sm:h-[700px] lg:h-[800px] rounded-[24px] sm:rounded-[40px] overflow-hidden bg-[#2a2a2a]">
            ...
            <div className="absolute top-0 left-0 bg-white rounded-br-[20px] sm:rounded-br-[40px] pr-6 sm:pr-12 pb-6 sm:pb-10 pt-6 sm:pt-8 pl-4 sm:pl-8 lg:pl-10 z-20">
              ...
              <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }} className="text-[34px] sm:text-[54px] lg:text-[76px] font-[700] leading-[0.95] tracking-tight text-[#0a0a0a] m-0 p-0 text-left">
          ...
          <div className="relative z-10 px-8">
            ...
            <div className="flex md:hidden flex-col gap-4 relative z-10">
              {[
                ...
                {
                  title: "Generator & Backup", desc: "Power Systems",
                  icon: <BatteryCharging size={40} strokeWidth={2} className="text-[#3e976c] mb-6" />
                },
                {
                  title: "Load Calculations", desc: "& Panel Schedules",
                  icon: <ChartNoAxesColumnIncreasing size={40} strokeWidth={2} className="text-[#3e976c] mb-6" />
                },
                {
                  title: "Short Circuit", desc: "& Voltage Drop Analysis",
                  icon: <Layers size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
                },
                {
                  title: "Grounding & Bonding", desc: "System Design",
                  icon: <ShieldCheckIcon size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
                },
                {
                  title: "Arc Flash Analysis", desc: "& Code Compliance",
