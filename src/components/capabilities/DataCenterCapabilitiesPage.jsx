...
export default function CapabilitiesPage() {
  const powerGrid = [
    ...
    },
    {
      ...
      desc: "Power Systems",
      icon: (
        <BatteryCharging size={40} strokeWidth={2} className="text-[#3e976c] mb-8" />
      )
    },
    {
      ...
      icon: (
        <ChartNoAxesColumnIncreasing size={40} strokeWidth={2} className="text-[#3e976c] mb-8" />
      )
    },
    {
      title: "Short Circuit",
      ...
      icon: (
        <battery-charging size={40} strokeWidth={2} className="text-[#3e976c] mb-8" />
      )
    },
    {
      ...
      <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 pt-4 relative isolate">
        <div className="relative w-full h-[500px] sm:h-[700px] lg:h-[800px] rounded-[24px] sm:rounded-[40px] overflow-hidden bg-[#2a2a2a]">
          ...
          <div className="absolute top-0 left-0 bg-white rounded-br-[20px] sm:rounded-br-[40px] pr-6 sm:pr-12 pb-6 sm:pb-10 pt-6 sm:pt-8 pl-4 sm:pl-8 lg:pl-10 z-20">
            ...
            <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }} className="text-[34px] sm:text-[54px] lg:text-[76px] font-[600] leading-[0.95] tracking-tight text-[#0a0a0a] m-0 p-0 text-left">
              Data Center &amp;<br /><span className="text-[#3e976c]">Mission-Critical <span className="text-[#0a0a0a]">Infrastructure</span></span>
            </h1>
          </div>
      ...
      <section className="w-full max-w-full mx-auto px-4 sm:px-8 lg:px-12 py-16 sm:py-24 relative isolate overflow-hidden">
        ...
        <div className="relative z-10 px-8">
            ...
            {[
              {
                ...
                desc: "Architecture & Distribution",
                icon: (
                  <Zap size={40} strokeWidth={1.75} className="text-[#3e976c] mb-8" />
                )
              },
              {
                title: "UPS, ATS & PDU",
                desc: "Configuration Design",
                icon: (
                  <BatteryCharging size={40} strokeWidth={2} className="text-[#3e976c] mb-8" />
                )
              },
              {
                ...
                icon: (
                  <Thermometer size={40} strokeWidth={2} className="text-[#3e976c] mb-8" />
                )
              },
              {
                title: "Equipment Room",
                desc: "Layout & Cable Management",
                icon: (
                  <Layers size={40} strokeWidth={1.75} className="text-[#3e976c] mb-8" />
                )
              },
              {
                title: "SCIF & Secure Operations",
                desc: "Center Design",
                icon: (
                  <ShieldCheckIcon size={40} strokeWidth={1.75} className="text-[#3e976c] mb-8" />
                )
              },
              {
                title: "Commissioning Support",
                desc: "& MOP/SOP Documentation",
                icon: (
                  <FileText size={40} strokeWidth={1.75} className="text-[#3e976c] mb-8" />
                )
              }
            ].map((item, idx) => (
              <div
                key={idx}
                className={`p-8 lg:p-12 flex flex-col ${idx < 3 ? 'border-b border-gray-100' : ''} ${idx % 3 !== 2 ? 'border-r border-gray-100' : ''} transition-colors hover:bg-white`}
              >
                {item.icon}
          ...
          <div className="flex md:hidden flex-col gap-4 relative z-10">
            {[
              {
                title: "Redundant Power", desc: "Architecture & Distribution",
                icon: <Zap size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
              },
              {
                title: "UPS, ATS & PDU", desc: "Configuration Design",
                icon: <BatteryCharging size={40} strokeWidth={2} className="text-[#3e976c] mb-6" />
              },
              {
                title: "Cooling Infrastructure", desc: "& Thermal Management",
                icon: <Thermometer size={40} strokeWidth={2} className="text-[#3e976c] mb-6" />
              },
              {
                title: "Equipment Room", desc: "Layout & Cable Management",
                icon: <Layers size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
              },
              {
                title: "SCIF & Secure Operations", desc: "Center Design",
                icon: <ShieldCheckIcon size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
              },
              {
                title: "Commissioning Support", desc: "& MOP/SOP Documentation",
                icon: <FileText size={40} strokeWidth={1.75} className="text-[#3e976c] mb-6" />
              },
            ].map((item, idx) => (
              <div key={idx} className="p-6 bg-white rounded-none shadow-sm border border-gray-100 flex flex-col pt-8">
                {item.icon}
