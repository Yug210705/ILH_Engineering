              ...
              <div className="absolute inset-0 z-10 p-4 lg:p-8">
                ...
                <div className="absolute bottom-[1%] right-[-1%] sm:bottom-[-2.5%] sm:right-[-5%] lg:bottom-[0.5%] lg:right-[0%]">
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="bg-[#3e976c] hover:bg-[#347d5a] text-white flex items-center justify-center gap-4 px-[58px] sm:px-[62px] py-5 sm:py-6 rounded-none lg:rounded-[18px] text-[17px] sm:text-[18px] lg:text-[19px] font-[800] transition-all shadow-xl shadow-[#3e976c]/30 min-w-[255px] sm:min-w-[315px] lg:min-w-[355px]"
                  >
